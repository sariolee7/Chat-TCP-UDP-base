...
public class AudioUI : MonoBehaviour, IAudioUI
{
    ...
    private AudioMessageUI _lastSentMessageUI;
    ...
    public GameObject InstantiateSentAudio(byte[] audioBytes)
    {
        if (sentAudioPrefab == null || chatContent == null) return null;
    ...
    public GameObject InstantiateReceivedAudio(byte[] audioBytes)
    {
        if (receivedAudioPrefab == null || chatContent == null) return null;
